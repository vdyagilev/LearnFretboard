...
class Note(GuessMaker):
    ...
    def play_sound(self, millisecs, volume=1.0):
        # create pygame sound from frequency
        sound = make_pygame_sound_from_freq(self.frequency, volume)
    ...
    def play_overtoned_sound(self, millisecs, n=11):
